...
struct collision_vectors momentum_t(struct collider_object obj1, struct collider_object obj2)
{
  ...
  // printf("%f %f %f %f %f %f %f", phi, theta1, theta2, v12.x, v12.y, v21.x, v21.y);
  vec.v12 = v12;
  vec.v21 = v21;
  return vec;
}
...
struct collision_vectors vec1;
vecinit(&obj1.vector, 0.707, -0.707);
vecinit(&obj1.centre, 50.0, 100.0);
vecinit(&obj2.vector, -0.707, 0.707);
vecinit(&obj2.centre, 100.0, 50.0);
obj1.mass = 1.0;
obj2.mass = 10.0;
vec1 = momentum_t(obj1, obj2);
printf("\nTRIGONOMETRY - object1 vector : (x:%f y:%f) ", vec1.v12.x, vec1.v12.y);
...
//}
//clock_t end = clock();
//float time_spent = (float)(end - begin) / (float)CLOCKS_PER_SEC;
...
//m1 = 10.0;
//m2 = 10.0;
//vec2= momentum_angle_free(v1.x, v1.y, v2.x, v2.y, m1, m2, x1.x, x1.y, x2.x, x2.y);
//printf("\nANGLE FREE - object1 vector : (x:%f y:%f) ", vec2.v12.x, vec2.v12.y);
//printf("\nANGLE FREE - object2 vector : (x:%f y:%f) ", vec2.v21.x, vec2.v21.y);
//
//// ------ TIMING TEST
...
//vecinit(&x2, 200.0, 100.0);
//
//float v1x, v1y, v2x, v2y, x1x, x1y, x2x, x2y;
//v1x = v1.x;
//v1y = v1.y;
//v2x = v2.x;
//v2y = v2.y;
...
///* here, do your time-consuming job */
//for (i=0; i<=n2; ++i){
// vec2=momentum_angle_free(v1x, v1y, v2x, v2y, m1, m2, x1x, x1y, x2x, x2y);
//}
//end = clock();
...
///* here, do your time-consuming job */
//for (i=0; i<=n2; ++i){
// vec2=momentum_angle_free1(obj1, obj2);
//}
//end = clock();
//time_spent = (float)(end - begin) / (float)CLOCKS_PER_SEC;
//printf("\nANGLE FREE1 - total time %f :", time_spent);
